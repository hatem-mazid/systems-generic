<template>
    <div
        class="flex start-0 flex-col h-screen !w-20 border dark:border-surface-700 bg-white dark:bg-surface-900 fixed top-0 bottom-0 z-50"
    >
